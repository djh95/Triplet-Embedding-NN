...
def compute_loss(data, x_images, y_tags, image_model, tag_model, triplet_loss, Lambda, Margin_Dis, global_sam):
...
def single_epoch_computation(image_model, tag_model, loader, triplet_loss, Lambda, Margin_Dis, global_sam, optim=None, updata=False):
    loss = 0
    IT_positive_dis = 0
    II_positive_dis = 0
    IT_negative_dis = 0
    ...
    for (x_images,y_tags) in loader:
        ...
        res = compute_loss(loader.dataset, x_images, y_tags, image_model, tag_model, triplet_loss, Lambda, Margin_Dis, global_sam)
